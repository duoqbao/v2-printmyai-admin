...
export default function PageNotFound() {
  ...
  useEffect(() => {
    ...
    gsap.to(starsBigRef.current.children, {
    ...
    gsap.fromTo(
      starsSmallRef.current.children,
    ...
    gsap.to(circlesSmallRef.current.children, {
      y: -4,
      yoyo: true,
      duration: 1,
      ease: "sine.inOut",
    ...
    gsap.to(circlesBigRef.current.children, {
      y: -2,
      yoyo: true,
      duration: 1,
      ease: "sine.inOut",
  ...
  return (
    <div className="container PageNotFound">
      <Row gutter={[12, 12]} className="row">
        <Col span={12} className="col-md-6 align-self-center">
          <svg
            version="1.1"
          ...
          >
			...
			M483.985,127.43c23.462,1.531,52.515,2.436,83.972,2.436c36.069,0,68.978-1.19,93.922-3.149"
              ...
              <g id="spaceman" ref={spacemanRef} clip-path="url(cordClip)">
                <path
                  id="cord"
                  fill="none"
                  stroke="#0E0620"
